...
class PinPutWidget extends StatelessWidget {
  ...
  const PinPutWidget({super.key, required this.controller, this.forceErrorState = false});
  ...
  Widget build(BuildContext context) {
    ...
    return Pinput(
      ...
      preFilledWidget: Text('-', style: AppStyles.bodyMDRegular.copyWith(color: AppColors.textSecondary)),
